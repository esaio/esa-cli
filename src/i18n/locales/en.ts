...
export const en = {
  ...
  api: {
    desc: "Call an arbitrary esa API endpoint (escape hatch)",
    endpointArg: "API path starting with / (e.g. /v1/teams/{team}/posts)",
    ...
    invalidEndpoint: "Endpoint must start with /: {{endpoint}}",
